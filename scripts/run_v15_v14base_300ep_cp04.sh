...
# v15 = v14 + 50 epoch
# 改动 (相对 v14):
#   - epochs: 250 → 300（让 cp=0.4 训久点，看能否破 0.90）
# 其他 100% 沿用 v14 配置（v12base + 3gt + cp=0.4）
# 预训练起点: repos/Hyper-YOLO/hyper-yolon.pt（不沿用 v14 best.pt）
set -u
cd /home/pi/projects/hyperyolo

NAME="v15_v14base_300ep_cp04"

echo "===== 检查现有 ultralytics 进程 ====="
ps -ef | grep -v grep | grep "ultralytics" | head -5 || echo "  (无现有进程)"

echo "===== 启动 v15 (= v14 + 50 epoch) 300 epoch ====="
echo "改动: epochs 250→300，其他 100% 沿用 v14 (v12base + 3gt + cp=0.4)"
