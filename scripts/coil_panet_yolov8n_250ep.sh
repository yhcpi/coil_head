#!/usr/bin/env bash
# 2026-07-15 Coil-PANet 创新点 (yolov8n baseline neck 极简版, 删 P5/SPPF 检测层)
# 注意: Detect layer 数被 yaml 改成 2 (stride=[8, 16]) -> 论文 trade-off 验证.
set -e
cd /home/pi/projects/hyperyolo

NAME="v0_coil_panet_yolov8n_250ep"
...
PYTHONPATH= /home/pi/anaconda3/envs/hyper-yolo/bin/yolo detect train \
  model=repos/ultralytics/ultralytics/cfg/models/coil_exp/yolov8n_panet.yaml \
