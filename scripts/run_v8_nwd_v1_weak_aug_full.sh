#!/bin/bash
# v8 NWD v1 弱 aug 250 epoch full — 保留 epoch 权重 + best.pt
#
# 对比 run_v8_nwd_v1_pure_cli_full.sh：补 save_period=10 保住 epoch checkpoint
# 弱 aug 配置 (与 pure_cli 一致):
#   degrees=0, flipud=0, copy_paste=0, scale=0.5, multi_scale=0
# 目标: 复现 0.93+ mAP50 用于部署 TTA+top-2+dist=50 达到 F1=0.91
set -u
cd /home/pi/projects/hyperyolo

NAME="v8_nwd_v1_weak_aug_full"
