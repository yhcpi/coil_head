#!/bin/bash
# v8 NWD 替换 IoU 250 epoch full 训练
# smoke 验证：5 epoch box_loss 17.4 → 5.4，mAP=0.338（baseline 同 epoch 0.099）
# 用法: bash scripts/run_v8_nwd_full.sh
set -u
