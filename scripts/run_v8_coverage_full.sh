#!/bin/bash
# v8 Coverage 250 epoch full 训练（loss.py 修复后）
# 关键前置：Coverage loss.py 修复 + 5 epoch smoke 验证收敛
# 用法: bash scripts/run_v8_coverage_full.sh
set -u
cd /home/pi/projects/hyperyolo

NAME="v8_coverage_full"
