#!/usr/bin/env bash
# 2026-07-15 H21:50 baseline 重置: 用 hyper-yolon.pt + 强 aug + 250 ep
# Plan C: 沿用 v13 v12base 路径, 它的 mAP50=0.82+ 在 ep250 已验证.
# 关键修复: box=1.5 + nwd=True + 强 aug - 用 v12 baseline 同款.
set -e
