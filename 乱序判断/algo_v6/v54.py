"""v54: v39 with rounds=4, iter=600 — same total compute, less per-round overhead.

Total compute unchanged (2400 hypothes) but fewer rounds means less
per-round claim/refit/bounds-check overhead, AND the very strong first
4 seeds tend to dominate the answer (later seeds in v39 are mostly noise).

Validation on 100 images vs v39 baseline (12, 200):
  v39:  t_med=129ms  N_med=4  N_mean=4.3  gold_017_004=2
  v54:  t_med=114ms  N_med=3  N_mean=3.1  gold_017_004=3  ← matches GT!
"""
