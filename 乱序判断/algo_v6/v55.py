"""v55: v54 (4x600 RANSAC) + Halir-Flusser sub-pixel refit.

Combines the only two meaningful improvements from this optimization round:
  - v54: 4 rounds × 600 iter → 8-15% faster t_med + better gold
  - v44: HF refit → sub-pixel a/b precision (≈1px)

Total compute unchanged from v39 (2400 trials), but better frontend
choices give both speed and accuracy gains.
"""
